...
\def\CylHeight{2.5}          % Height H of the cylinder
\def\LowerFlapHeight{0.5}          % Height of the lower flap
\def\nTeeth{11}       % Total number of teeth
\def\ToothHeight{1}           % Height of a tooth
\def\ToothWidth{0.75}  % Width of a tooth
\def\LeftFlapWidth{1.1}          % Width of the left flap
...
\def\ToothAngleRadius{0.9}
\def\ToothAngleLabelYShift{0.7}
